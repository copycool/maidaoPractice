...
INSERT INTO `course` VALUES (1, 1, '语文', '必修课');
INSERT INTO `course` VALUES (2, 2, '音乐', '选修课');
INSERT INTO `course` VALUES (3, 3, '体育', '选修课');
...
INSERT INTO `students` VALUES (25, 2021001, '小王', '女', 1);
INSERT INTO `students` VALUES (26, 2021002, '小李', '男', 2);
INSERT INTO `students` VALUES (27, 2021003, '小张', '女', 1);
INSERT INTO `students` VALUES (28, 2021004, '小明', '女', 2);
INSERT INTO `students` VALUES (29, 2021005, '小虎', '男', 1);
INSERT INTO `students` VALUES (30, 2021006, '小昭', '女', 2);
INSERT INTO `students` VALUES (31, 2021007, '小孙', '男', 1);
...
SELECT class_no FROM classes s WHERE s.`class_name`='一班'；
SELECT snumber FROM students s WHERE s.`class_no`=(
SELECT class_no FROM classes s WHERE s.`class_name`='一班');

SELECT snumber,SUM(scores) SUM FROM score s WHERE s.`snumber`=ANY(
SELECT snumber FROM students s WHERE s.`class_no`=(
SELECT class_no FROM classes s WHERE s.`class_name`='一班')) GROUP BY snumber ORDER BY SUM DESC;
