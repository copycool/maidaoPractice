...
// 1.获取当前时间的时间戳
// 2. 获取前一天当前时间的时间戳 
// 3. 输出当前时间的年月日，格式为“yyyy-MM-dd”
// 4. 分别获取今天、昨天的开始时间和结束时间的时间戳 
// 5. 计算两个 Date 类型对象之间相隔的天数
...
private static final long MILLISECOND_OF_DAY = 24 * 60 * 60 * 1000;
    ...
    public static void main(String[] args) {
        ...
        // 计算两个Date类型对象之间相隔的天数
        Calendar cal1=Calendar.getInstance();  //实例化calendar对象
        cal1.set(2018, 4, 20);
        Date date1=cal1.getTime();  //得Sun May 20 23:47:22 CST 2018
        Long d1=date1.getTime();    //函数返回long得1526831302878
        System.out.println(d1);   

        Calendar  cal2=Calendar.getInstance();
        cal2.set(2021, 7, 15);   
        Date date2=cal2.getTime();  //date2为Sun Aug 15 23:52:33 CST 2021
        Long d2=date2.getTime();    //函数返回long得1526831302878
        System.out.println(d2);     
        System.out.println("相差的天数为："+Math.abs(d1-d2)/24/3600000);//时间戳默认是毫秒
    }
