...
-- 升序：asc  降序：desc
mysql> select * from student where order by first_name desc;
...
mysql> insert into student(id,first_name,last_name,sex,school) values(null,'null','Wilson',null,'null');
