CREATE TABLE sstudent (
	...
	`sno` VARCHAR ( 30 ) CHARACTER 
	SET utf8 DEFAULT NULL COMMENT '学号',
	`sna` VARCHAR ( 30 ) CHARACTER 
	SET utf8 DEFAULT NULL COMMENT '姓名',
	`ssex` TINYINT ( 2 ) COMMENT '性别',
	PRIMARY KEY ( `id` ) 
)ENGINE = INNODB DEFAULT charset = utf8;
 INSERT INTO sstudent ( sno, sna, ssex )
VALUES
	( '201801', '江一', '1' );
	INSERT INTO sstudent ( sno, sna, ssex )
VALUES
...
create table class(
`id` BIGINT ( 20 ) NOT NULL auto_increment,
`cnumber`  VARCHAR ( 30 )  CHARACTER SET utf8 DEFAULT NULL COMMENT '班号',
`cname`  VARCHAR ( 30 )  CHARACTER SET utf8 DEFAULT NULL COMMENT '班级名称',
PRIMARY KEY (`id`)
)ENGINE = INNODB DEFAULT charset = utf8;
INSERT INTO class ( cnumber, cname)
VALUES
	( '01', '软工41' );
	INSERT INTO class ( cnumber, cname)
VALUES
...
create table course(
`id` BIGINT ( 20 ) NOT NULL auto_increment,
`conumber`  VARCHAR ( 30 )  CHARACTER SET utf8 DEFAULT NULL COMMENT '课程号',
`coname`  VARCHAR ( 30 )  CHARACTER SET utf8 DEFAULT NULL COMMENT '课程名称',
`cocharacter`  VARCHAR ( 30 )  CHARACTER SET utf8 DEFAULT NULL COMMENT '课程性质',
PRIMARY KEY (`id`)
);
INSERT INTO course ( conumber, coname, cocharacter )
VALUES
	( '001', '计算机导论', '选修课' );
INSERT INTO course ( conumber, coname, cocharacter )
VALUES
...
create table score(
`id` BIGINT ( 20 ) NOT NULL auto_increment,
`cou_id`  VARCHAR ( 30 )  CHARACTER SET utf8 DEFAULT NULL COMMENT '课程号',
`stu_id`  VARCHAR ( 30 )  CHARACTER SET utf8 DEFAULT NULL COMMENT '学号',
`sscore`  VARCHAR ( 30 )  CHARACTER SET utf8 DEFAULT NULL COMMENT '成绩',
PRIMARY KEY (`id`)
);
...
`id` BIGINT(20)NOT NULL auto_increment,
`stu_id` VARCHAR(30) CHARACTER SET utf8 default null comment'学号',
`cla_id` VARCHAR(30) CHARACTER SET utf8 default  null comment'班级号',
PRIMARY KEY(`id`)
)ENGINE=INNODB DEFAULT charset=utf8;
